...
`SWAMPE` has the capability to run simulations of planetary atmospheres based on planetary parameters. The user can specify physical parameters such as radius, surface gravity, rotation rate, stellar radiation, and scale height. The parameter space is vast in an exoplanetary setting.  
